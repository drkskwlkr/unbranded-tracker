...
- Добавен е незадължителен параметър за превключване на езика на UT между български и английски. За да го използвате, трябва да добавите към края на заявката &lang=bg (български) или &lang=en (английски). Ако се изпусне този параметър, страницата ще извлече и покаже статуса на проследяване на български. В бъдеща версия поведението по подразбиране ще може да се задава чрез настройка на параметър в config.inc.php
