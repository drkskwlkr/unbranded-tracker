...
### Как да инсталирате
Нужно е да копирате отново четирите файла (`config.inc.php`, `index.php`, `track.php` и `style.css`). Като ги презаписвате, най-напред си запазете настройките от предишната версия на `config.inc.php` в частта `# Administrative` и `# Speedy User Details` и след това ги пренесете в новия файл.
