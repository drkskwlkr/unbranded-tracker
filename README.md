# unbranded-tracker
One-page приложение за проследяване на доставките. За простота ще наричам приложението UT (от Unbranded Tracker; няма нищо общо с Unreal Tournament, uTorrent или Ути Бъчваров).
...
- Лео Експрес
- CVC
и предоставя подробни тракинг данни, чрез които вашите потребители могат да се информират за движението на своите пратки. Поддръжка за други куриери може да бъде реализирана според техническите възможности и интереса. Ако имате интерес към конкретен куриер, питайте.
...
- [Примерен резултат с A1 Post](https://utdemo.webstage.dev/?p=61605758143)
