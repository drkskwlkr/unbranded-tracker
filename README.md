# unbranded-tracker
One-page приложение за проследяване на доставките. Съвместимо със Спиди, Еконт и A1 Post (други куриери TBDL). За простота ще наричам приложението UT (от Unbranded Tracker; няма нищо общо с Unreal Tournament, uTorrent или Ути Бъчваров).
