# unbranded-tracker
One-page приложение за проследяване на доставките. Съвместимо със Спиди, Еконт, A1 Post и Лео Експрес (други куриери TBDL). За простота ще наричам приложението UT (от Unbranded Tracker; няма нищо общо с Unreal Tournament, uTorrent или Ути Бъчваров).
...
## Инсталация
Трябва да свалите четири файла от GitHub:
```
config.inc.php
index.php
style.css
